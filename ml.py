...
class Model(Resource):
    def post(self):
        ...
        parser.add_argument('symptoms', required=True)  # add args
        
        args = parser.parse_args()  # parse arguments to dictionary

        print(args, predict(args['symptoms'].split(',')))
        return {'disease': predict(args['symptoms'].split(','))}, 200  # return data with 200 OK

api.add_resource(Model, '/model')  # '/users' is our entry point for Users
